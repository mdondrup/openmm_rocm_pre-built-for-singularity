...
class LangevinMiddleIntegrator(Integrator):
    ...
    for _s in [Integrator]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, LangevinMiddleIntegrator, name, value)
    __swig_getmethods__ = {}
    for _s in [Integrator]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, LangevinMiddleIntegrator, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        ...
        stepSize : double
            the step size with which to integrate the system (in picoseconds)
        """
        this = _openmm.new_LangevinMiddleIntegrator(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
LangevinMiddleIntegrator_swigregister = _openmm.LangevinMiddleIntegrator_swigregister
LangevinMiddleIntegrator_swigregister(LangevinMiddleIntegrator)
...
class DrudeIntegrator(Integrator):
    ...
    for _s in [Integrator]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, DrudeIntegrator, name, value)
    __swig_getmethods__ = {}
    for _s in [Integrator]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, DrudeIntegrator, name)
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        ...
        stepSize : double
            the step size with which to integrator the system (in picoseconds)
        """
        this = _openmm.new_DrudeIntegrator(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
DrudeIntegrator_swigregister = _openmm.DrudeIntegrator_swigregister
DrudeIntegrator_swigregister(DrudeIntegrator)
...
class Continuous3DFunction(TabulatedFunction):
    ...
    def __init__(self, xsize, ysize, zsize, values, xmin, xmax, ymin, ymax, zmin, zmax, periodic=False):
        ...
        This is a TabulatedFunction that computes a continuous three dimensional function.
        """
        this = _openmm.new_Continuous3DFunction(xsize, ysize, zsize, values, xmin, xmax, ymin, ymax, zmin, zmax, periodic)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class Continuous2DFunction(TabulatedFunction):
    ...
    def __init__(self, xsize, ysize, values, xmin, xmax, ymin, ymax, periodic=False):
        ...
        This is a TabulatedFunction that computes a continuous two dimensional function.
        """
        this = _openmm.new_Continuous2DFunction(xsize, ysize, values, xmin, xmax, ymin, ymax, periodic)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class Continuous1DFunction(TabulatedFunction):
    ...
    def __init__(self, values, min, max, periodic=False):
        ...
        This is a TabulatedFunction that computes a continuous one dimensional function.
        """
        this = _openmm.new_Continuous1DFunction(values, min, max, periodic)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class AmoebaVdwForce(Force):
    ...
    def addParticle(self, *args):
        ...
        addParticle(self, parentIndex, typeIndex, reductionFactor) -> int
